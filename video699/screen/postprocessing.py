...
def approximate_erose_dilate(pred, lower_bound, upper_bound, iterations, factors):
    ...
    for quadrangle in quadrangles:
        ...
        _, contours, _ = cv2.findContours(dilated_quadrangle, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
...
def approximate_ratio_split(quadrangles, lower_bound, upper_bound):
    ...
    for quadrangle in quadrangles:
        ...
        if lower_bound < geos_quadrangle.height / geos_quadrangle.width < upper_bound or geos_quadrangle.area < 80000:
